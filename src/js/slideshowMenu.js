...
const slideshowMenuContent = document.querySelector('.slideshow-menu__content');
if (slideshowMenuContent) {
  const slideshowPictures = [...document.querySelectorAll('.slideshow-menu__card')];

  const arrowLeft = document.querySelector('.slideshow-menu__arrow--container-left');
  const arrowRight = document.querySelector('.slideshow-menu__arrow--container-right');


  createRoomTypeSlideshow(slideshowMenuContent, slideshowPictures, arrowLeft, arrowRight, desktop, tab);
}
